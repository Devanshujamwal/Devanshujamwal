...
**IT Support · Systems · Networking · Cloud**  
Calgary, Alberta, Canada

I’m an early-career IT professional and SAIT Information Technology Services graduate focused on troubleshooting, infrastructure, networking, cloud technologies, and reliable end-user support.
...
- **Systems:** Windows, Linux, macOS, Microsoft 365
- **Networking:** TCP/IP, DNS, DHCP, VLANs, OSPF, NAT, Cisco networking, Packet Tracer, Wireshark
- **Cloud:** Microsoft Azure, Virtual Machines, Virtual Networks, Azure Storage, RBAC, Azure Monitor, Log Analytics
- **Security:** Palo Alto Networks, Wazuh, SIEM fundamentals, endpoint monitoring, firewall policy concepts
- **Virtualization:** VMware
- **Support & tools:** ServiceNow, Jira, Git, GitHub, VS Code
- **Programming:** Python, C/C++, HTML/CSS, Next.js
...
Information Technology Services Diploma · Calgary, Alberta

Relevant areas include networking, cloud computing, cybersecurity, virtualization, systems administration, Linux, scripting, and programming.
